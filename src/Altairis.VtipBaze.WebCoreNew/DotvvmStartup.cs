...
namespace Altairis.VtipBaze.WebCore
{
    public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
    {
        ...
        private void ConfigureRoutes(DotvvmConfiguration config, string applicationPath)
        {
            ...
            config.RouteTable.Add("SingleJoke", "joke/{JokeId:int}/{PageIndex?:int}", "Views/HomePage.dothtml", new { PageIndex = 1 });
        ...
        private void ConfigureResources(DotvvmConfiguration config, string applicationPath)
        {
            ...
            config.Resources.RegisterStylesheetFile("main-css", "wwwroot/Styles/main.css");
            config.Resources.RegisterScriptFile("jquery", "wwwroot/Scripts/jquery-2.0.3.min.js");
            ...
            config.Resources.RegisterScriptFile("jquery-ui", "wwwroot/Scripts/jquery-ui-1.10.3.min.js", dependencies: new[] { "jquery", "jquery-ui-css" });
            config.Resources.RegisterScriptFile("site", "wwwroot/Scripts/Site/ui.js", dependencies: new[] { "jquery-ui", "main-css" });
        }
