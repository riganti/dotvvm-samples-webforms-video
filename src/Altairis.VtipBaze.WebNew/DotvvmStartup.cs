...
namespace Altairis.VtipBaze.WebCore
{
    public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
    {
        ...
        private void ConfigureResources(DotvvmConfiguration config, string applicationPath)
        {
            ...
            config.Resources.RegisterStylesheetFile("site-css", "wwwroot/Styles/main.min.css", dependencies: new[] { "jquery-ui-css" });

            config.Resources.RegisterScriptFile("site", "wwwroot/Scripts/Site/ui.js", dependencies: new[] { "jquery-ui" });
            config.Resources.RegisterScriptFile("jquery-ui", "wwwroot/Scripts/jquery-ui-1.10.3.min.js", dependencies: new[] { "jquery" });
